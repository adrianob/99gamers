class UserPolicy < ApplicationPolicy
  ...
  def permitted_attributes
    u_attrs = [:reset_password_url, :raiseit_id, :raiseit_key, :current_password, :password, :subscribed_to_project_post, bank_account_attributes: [:bank_id, :name, :agency, :account, :owner_name, :owner_document, :account_digit, :agency_digit] ]
