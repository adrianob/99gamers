 ...
 #mount CatarseWepay::Engine => "/", as: :catarse_wepay
  ...
  resources :plans do
    resources :subscriptions, except: [:index] do
      collection do
        get :fallback_create, to: 'subscriptions#create'
      end
    end
  end
  ...
  get "/embaixadores" => 'high_voltage/pages#show', id: 'embaixadores'
  get "/duvidas-frequentes" => 'high_voltage/pages#show', id: 'duvidas-frequentes'
